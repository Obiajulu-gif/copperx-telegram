			...
			<div className="container max-w-5xl mx-auto">
				<div className="flex flex-col items-center text-center mb-12">
					...
					<p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mb-8">
						Manage your Copperx stablecoin transactions directly through
						Telegram
					</p>
				...
				<Card className="mb-12">
					<CardHeader>
						...
						<CardDescription>
							Follow these steps to start using the Copperx Telegram Bot
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">
									Search for @CopperxPayoutBot on Telegram
								</p>
							</div>
						</div>
						<div className="flex items-start gap-4">
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<p className="text-sm text-gray-600 dark:text-gray-400">
									Use commands like /balance, /send, and /withdraw to manage
									your funds
								</p>
							</div>
						</div>
					...
					<CardFooter>
						<Link
							href="https://t.me/copperxcommunity/2183"
							target="_blank"
							rel="noopener noreferrer"
						>
